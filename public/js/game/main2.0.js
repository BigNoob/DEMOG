...
function StartLoading()
{
      ...
      scoreText = new createjs.Text("", "20px Arial", "#FFFFFF");
      scoreText.text = score;
      scoreText.y = 100;
      scoreText.x = stagewidth - scoreText.getMeasuredWidth() / 2;
...
function serverMessageParser(data)
{
      ...
      switch(splittedData[0])
      {
            ...
            case 'EU':
                  ...
                  break;
            case 'ED':
                  if(!isSyncer){syncDeath(splittedData);}
                  break;
      }
}
...
function syncEnemies(coord)
{
      ...
      for (var i = 0; i < 4; i++) {
            for (var j = 0; j < 7; j++) {
                  ...
                  if(enemyAliveArray[index] == 0)
                  {
                    invaderArray[index].alpha = 0;
                  }
...
function syncDeath(coord)
{
    invaderArray[parseInt(coord[1])].alpha = 0;
    score += 100;
    scoreText.text = score;
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
